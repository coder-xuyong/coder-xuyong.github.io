...
## 自我介绍
您好，我22年毕业后，一直专注于 Java 后端开发，拥有3年多的的独立开发和项目经验。

我技术栈的核心是 Java，对 JVM、MySQL、SpringBoot 等有深入的了解和应用经验，并能处理线上高并发和性能问题。在项目中，我具备独立负责一个产品从零到一研发的能力，曾主导公司核心的【叶片总成】后端开发，使用 Netty 进行高频数据采集，也负责过现有【OA系统】的迭代维护。其他项目涉及到python、C#语言等。

除了技术，我对项目跟进和交付也有实践经验。我乐于学习与分享，长期维护个人技术博客。相信我的技术能力和项目经验能够快速融入团队，为项目创造价值。
