...
```
添加一个名为 `src/test/java/ApplicationTests.java`文件

**重要文件**

- `src/main/java` 路径下的 `MyApplication` 类 ：程序入口
- `src/main/resources` 路径下的 `application.properties` ：项目配置文件
- `src/test/java` 路径下的 `ApplicationTests` ：程序测试入口
