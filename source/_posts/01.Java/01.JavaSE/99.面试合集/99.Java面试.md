...
一般，能用聚合就别用继承。聚合是“has-a”，类似 school 类存在 teachers 的变量。
...
hashmap 数组和链表多少长度时候，会转化为红黑树?

{% post_link 01.Java/01.JavaSE/01.基础特性/03.java高级#Set ' 🚀 HashMap底层' %}
## 并发
...
![img](https://raw.githubusercontent.com/coder-xuyong/coder-xuyong/main/img/blog/java/java-thread_1.png)
...
> 👉 参考阅读：{% post_link 01.Java/01.JavaSE/04.并发/02.Java并发核心机制 ' 🚀 java 并发核心机制' %}
...
**CAS（Compare and Swap）**，字面意思为**比较并交换**。CAS 有 3 个操作数，分别是：内存值 V，旧的预期值 A，要修改的新值 B。当且仅当旧预期值 A 和内存值 V 相同时，将内存值 V 修改为 B，否则什么都不做。
...
> 👉 参考阅读：{% post_link 01.Java/01.JavaSE/04.并发/04.Java并发和容器 ' 🚀 java 并发容器' %}
...
> 👉 参考阅读：：{% post_link 01.Java/01.JavaSE/04.并发/03.Java锁 ' 🚀 java 并发锁' %}
...
> 👉 参考阅读：：{% post_link 01.Java/01.JavaSE/04.并发/05.Java并发工具类 ' 🚀 java 并发工具类' %}
...
![img](https://raw.githubusercontent.com/dunwu/images/master/cs/java/javacore/concurrent/java-thread-pool_1.png)
...
> 类的生命周期是什么？
>
> 了解类加载器吗,JVM类加载的机制是什么？
>
> 👉 参考阅读：{% post_link 01.Java/01.JavaSE/03.JVM/04.jvm类加载 ' 🚀 JVM 类加载 '%}


#### 对象的创建过程了解吗？

![对象创建过程](https://raw.githubusercontent.com/coder-xuyong/coder-xuyong/main/img/blog/java/jvm/jvm_1.png)
...
对象创建在虚拟机中是非常频繁的操作，即使仅仅修改一个指针所指向的位置，在并发情况下也会引起**线程不安全**。
...
#### 对象的内存布局?
 参考阅读：{% post_link 01.Java/01.JavaSE/04.并发/02.Java并发核心机制#Java对象头 ' 🚀 Java对象头 '%}
...
堆内存是否规整：
![堆内存](https://raw.githubusercontent.com/coder-xuyong/coder-xuyong/main/img/blog/java/jvm/jvm_2.png)
...
- 指针碰撞方式：
  ...
  ![对象内存分配](https://raw.githubusercontent.com/coder-xuyong/coder-xuyong/main/img/blog/java/jvm/jvm_3.png)
- 空闲列表：
  - 堆内存不规整。
...
#### 能说一下JVM的内存区域吗？
> 👉 参考阅读：{% post_link 01.Java/01.JavaSE/03.JVM/01.jvm简介与内存架构 ' 🚀 JVM简介与内存架构 '%}
...
> 👉 参考阅读：{% post_link 01.Java/01.JavaSE/03.JVM/02.jvm垃圾回收#垃圾收集算法 ' 🚀 JVM垃圾收集算法 '%}
...
> 👉 参考阅读：{% post_link 01.Java/01.JavaSE/03.JVM/02.jvm垃圾回收#并发标记清除收集器 ' 🚀 JVM并发标记清除收集器 '%}

### OOM
#### 内存泄漏可能由哪些原因导致呢？

数据连接、IO、Socket等连接;threadLocal
...
- https://www.yuque.com/beyourself-twyxw/vgva7f/36bc1baac2bb9972b514ae644f1d1016